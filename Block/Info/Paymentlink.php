 ...
 * @link     https://www.mondido.com
 */
class Paymentlink extends Info
{
    /**
     * @var string
     */
    protected $_template = 'Mondido_Mondido::info/paymentlink.phtml';
     ...
     * @param array       $data
     */
    public function __construct(Context $context, Transaction $transaction, array $data = [])
    {
